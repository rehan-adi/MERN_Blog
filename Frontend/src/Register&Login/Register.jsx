    ...
    <div className='w-auto flex justify-around items-center h-screen bg-white text-black'>
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <input type="text" id="username" placeholder='Enter Username' name="username" className="px-3 py-2 w-[30vw] border rounded-xl bg-[#F8F4F8] focus:outline-none shadow appearance-none" value={formData.username} onChange={handleChange} />
          {errors.username && <p className="text-red-500">{errors.username}</p>}
        </div>
        <div className="mb-4">
          <label htmlFor="email" className="block mb-1">Email:</label>
          <input type="email" id="email" name="email" placeholder='Enter Email'  className="w-[30vw] px-3 py-2 border rounded-xl focus:outline-none bg-[#F8F4F8] shadow appearance-none " value={formData.email} onChange={handleChange} />
          {errors.email && <p className="text-red-500">{errors.email}</p>}
        </div>
        <div className="mb-4">
          <label htmlFor="password" className="block mb-1">Password:</label>
          <input type="password" id="password" placeholder='Enter Password' name="password" className="w-[30vw] px-3 py-2 border rounded-xl focus:outline-none shadow appearance-none bg-[#F8F4F8] " value={formData.password} onChange={handleChange} />
